...
var getMainMenuIdNodeTree = func(menuUI *MainMenuUI) []menuIdNode {
	return []menuIdNode{
		{id: menuNone, name: "Single Player", itemList: []menuIdNode{
			{id: menuSingleplay_missions, name: "Missions", itemList: nil, exec: menuUI.toMissionsUI},
			{id: menuSingleplay_replays, name: "Replays", itemList: nil},
			{id: menuNone, name: "Back", itemList: nil, exec: menuUI.back},
		}},
